...
<form id="formulario-conodetumadre" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	...
	<div class="row">
		...
		<input type="submit" class="update-cart-button button" name="update_cart" value="<?php _e( 'Atualização do carrinho', 'swiftframework' ); ?>" /> <input type="submit" class="checkout-button button alt" name="proceed" value="<?php _e( 'Finalizar pagamento', 'swiftframework' ); ?>" />
