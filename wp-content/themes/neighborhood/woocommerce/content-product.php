...
<li <?php post_class( $classes ); ?>>
	...
	<div class="clearfix" style="width:50%; margin:0px auto;"><a style="padding:5px 15px;float:left;border:1px solid #999" href="<?php the_title(); ?>">Adicionar</a><a style="color:white; font-weight:700; background-color:#EF3F32; padding:5px 15px;float:right;" href="<?php the_title(); ?>">Saiba mais</a></div>
</li>