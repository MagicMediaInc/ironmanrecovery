	...
	<div class="summary entry-summary">
		...
		if ($post->ID==161) { //solo mostramos personalizador en la página del colchón t24.7
			...
			if(stripos($ua,'iphone') !== false) { // && stripos($ua,'mobile') !== false) {
				?><a href="#personalizar" class="animate-iphone" style="background-color: #0093BD !important;color:#FFFFFF;border: 0 none;border-radius: 0;box-shadow: none;font-weight: bold;text-shadow: none;padding: 15px;width:250px;">Encuentra tu colchón</a> <?php
			}
			else if(stripos($ua,'android') !== false) { // && stripos($ua,'mobile') !== false) {
				?><a href="#personalizar" class="animate-android" style="background-color: #0093BD !important;color:#FFFFFF;border: 0 none;border-radius: 0;box-shadow: none;font-weight: bold;text-shadow: none;padding: 15px;width:250px;">Encuentra tu colchón</a> <?php
			}
			else{
			?><a href="#personalizar" class="animate-advisor" style="background-color: #0093BD !important;color:#FFFFFF;border: 0 none;border-radius: 0;box-shadow: none;font-weight: bold;text-shadow: none;padding: 15px;width:250px;">Encuentra tu colchón</a> <?php
			}
		}
		?>
...
?>
    ...
    <div id="container-colchones" class="container">
		...
		<div style="margin-top:20px" class="row">
			<div class="span6">
				<div class="seccion-personalizador">
				<h3>CAPA CUSTOM INDIVIDUAL : <span style="text-transform:uppercase" id="muestra-tipo-individual-publica"> - </span></h3>
				</div>
			</div>
			<div class="span6">
				<div id="capa-custom-pareja" class="seccion-personalizador">
				
				<h3>CAPA CUSTOM PAREJA : <span id="muestra-tipo-pareja-publica"> - </span></h3>
				</div>
			</div>
		</div>
...
<div style="width:93%;height:70%;margin:auto;margin-bottom: 50px;">
<iframe width="100%" height="70%"src="//www.youtube.com/embed/IDeyxDOKuYg" frameborder="0" allowfullscreen></iframe>
</div>
	<div class="row-fluid">
		<div class="container">
