	...
	<p class="form-row" id="shiptobilling">
		...
		$language_myqtrans = 'pt';
			...
			switch ($language_myqtrans) {
				case "es":
					$direccion= '¿Enviar a dirección de facturación?';
					break;
				case "fr":
					$direccion= 'Envoyer à l\'adresse de facturation?';
					break;
				case "pt":
					$direccion= 'Enviar ao endereço de cobrança?';
					break;
			}  
		
		?>
		<label for="shiptobilling-checkbox" class="checkbox"><?php _e( $direccion , 'woocommerce' ); ?></label>
