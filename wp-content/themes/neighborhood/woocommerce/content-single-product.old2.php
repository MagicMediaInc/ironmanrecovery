...
<div itemscope itemtype="http://schema.org/Product" id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="summary entry-summary">
		...
		<a class="animate-advisor" href="http://ironmanrecovery.com/#personalizar"><div style="background-color: #0093BD !important;color:#FFFFFF;border: 0 none;border-radius: 0;box-shadow: none;font-weight: bold;text-shadow: none;padding: 15px;width:250px;">Encuentra tu colchón</div></a>
	</div><!-- .summary -->
        ...
        <div id="personalizadores" class="row">
	        <div class="span6">
	        	<div class="personalizador" id="personalizador-individual" data-peso=0 data-altura=0 data-apoyo=0 data-presion="0">
		        	...
		        	<div class="seccion-personalizador">
			        	<h5>¿QUÉ SENSACIÓN DE APOYO PREFIERES?</h5>
			        	<div class="apoyos">
