<?php
	...
	*/
	...
	/* GET POST ITEM
	================================================== */ 
	function sf_get_post_item($postID, $blog_type, $show_title = "yes", $show_excerpt = "yes", $show_details = "yes", $excerpt_length = "60", $content_output = "excerpt", $show_read_more = "yes") {
