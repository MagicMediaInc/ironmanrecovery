...
<?php
	...
	$newletters = get_posts( array( 'post_type' => 'newletter') );
...
?>
	...
	<div id="tab-forms" class="tab">
		...
		<div class="subtab form" id="form-tab-<?php echo $form_id?>" <?php if(!$form_id) echo 'style="display:block"'; ?>>
			...
			<?php if(!$form_id) :?>
			<p class="description default-form-msg"><?php _e('This form is used for profile page and all other form specific settings', 'mymail' ); ?></p>
			<?php endif;?>
			<table class="nested">
