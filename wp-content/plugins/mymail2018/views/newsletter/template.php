...
<?php $autoplaintext = !isset($this->post_data['autoplaintext']) || $this->post_data['autoplaintext']?>
	...
	<textarea id="excerpt" name="excerpt" class="hiddens<?php if($autoplaintext) echo ' disabled' ?>" autocomplete="off" <?php disabled($autoplaintext); ?>><?php echo $post->post_excerpt ?></textarea>
</div>
