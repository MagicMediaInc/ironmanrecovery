...
class mymail {
	...
	public function init() {
		...
		if($system_mail = mymail_option('system_mail')){
	...
	public function sanitize_content($content, $userstyle = false, $bodyonly = false, $customhead = NULL) {
		...
		$allowed_tags = apply_filters('mymail_allowed_tags', array('address', 'a', 'big', 'blockquote', 'body', 'br', 'b', 'center', 'cite', 'code', 'dd', 'dfn', 'div', 'dl', 'dt', 'em', 'font', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'hr', 'html', 'img', 'i', 'kbd', 'li', 'meta', 'ol', 'pre', 'p', 'span', 'small', 'strike', 'strong', 'style', 'sub', 'sup', 'table', 'tbody', 'thead', 'tfoot', 'td', 'th', 'title', 'tr', 'tt', 'ul', 'u', 'map', 'area', 'video', 'audio', 'buttons', 'single', 'multi', 'modules', 'module', 'meta'));
	...
	public function wp_mail_set( $args ){
		...
		$file = mymail_option('system_mail_template');
	...
	public function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
		...
		return mymail_wp_mail( $to, $subject, $message, $headers, $attachments, mymail_option('system_mail_template', 'notification.html') );
